	...
	modules: [
		{
			...
			position: 'top_right',
			config: {
				apikey: '{{ .Values.secrets.darkSkyApi }}',
				latitude: '50.17659',
				longitude: '8.62685',
